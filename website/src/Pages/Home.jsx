                ...
                <div className="mx-auto max-w-2xl py-32 px-10 sm:py-48 lg:py-56 z-10">
                    <div className="text-left">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            <a href="#contacto" className="rounded-md bg-white px-3.5 py-2.5 text-xl font-semibold  shadow-sm text-gray-700 hover:bg-sky-900 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                                Agenda una reunión
                            </a>
                        </div>
                    </div>
